...
class Clock_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'Clock', // Name
			[ 'description' => __( 'Clock Widget', 'ai-content-generator-on-acf-field' ), ] // Args
		);
	}
	/**
	...
	public function form( $instance ) {
		if ( isset( $instance['title'] ) ) {
			...
			$title = __( 'New title', 'ai-content-generator-on-acf-field' );
		}
		?>
		<p>
			<label for="<?php echo $this->get_field_name( 'title' ); ?>"><?php _e( 'Title:', 'ai-content-generator-on-acf-field' ); ?></label>
