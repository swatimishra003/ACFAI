...
class Option {
  ...
  private $file;
	...
	protected function setup_hooks() {
		$this->file = FUTUREWORDPRESS_PROJECT_AICONTENTGENERATOR__FILE__;
		$this->plugin_slug = 'ai-content-generator-on-acf-field';
		$this->plugin_name = 'ai-content-generator-on-acf-field';
		$this->textdomain = 'ai-content-generator-on-acf-field'; // str_replace('_', '-', $plugin_slug);
	...
	public function init() {
		$this->general = (object) wp_parse_args( apply_filters( 'futurewordpress/project/aicontentgenerator/settings/general', [] ), [
			'page_title'					=> __( 'Configuration.', 'ai-content-generator-on-acf-field' ),
			'menu_title'					=> __( 'Config', 'ai-content-generator-on-acf-field' ),
			'role'								=> 'manage_options',
			'slug'								=> $this->plugin_slug,
			'page_header'					=> __( 'customization page.', 'ai-content-generator-on-acf-field' ),
			'page_subheader'			=> __( 'Your setting panel from where you can control and customize.', 'ai-content-generator-on-acf-field' ),
			'no_password'					=> __( 'A password is required.', 'ai-content-generator-on-acf-field' ),
		] );
	...
	public function add_settings_link( $links ) {
		$settings_link = '<a href="options-general.php?page='.$this->general->slug.'">' . __( 'Settings', 'ai-content-generator-on-acf-field' ) . '</a>';
		// array_push( $links, $settings_link );
		$links[] = $settings_link;
		// $links[] = '<a href="https://www.fiverr.com/mahmud_remal/" target="_blank">' . __( 'Developer Support', 'ai-content-generator-on-acf-field' ) . '</a>';
		return $links;
	}
	...
	private function settings_fields() {
		$settings = [];
		$settings = apply_filters( 'futurewordpress/project/aicontentgenerator/settings/fields', $settings );
		return $settings;
	}
	...
	public function display_field( $args ) {
		...
		switch( $field['type'] ) {
			...
			case 'radio':
			case 'select_multi':
				$html .= apply_filters( 'futurewordpress/project/aicontentgenerator/settings/fields/label', '<br/><span class="description">' . $field['description'] . '</span>', $field );
			break;

			default:
				$html .= apply_filters( 'futurewordpress/project/aicontentgenerator/settings/fields/label', '<label for="' . esc_attr( $field['id'] ) . '"><span class="description">' . $field['description'] . '</span></label>' . "\n", $field );
			break;
		}
