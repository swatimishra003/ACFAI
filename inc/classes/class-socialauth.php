...
class SocialAuth {
	...
	protected function setup_hooks() {
		$this->facebookAppID					= apply_filters( 'futurewordpress/project/aicontentgenerator/system/getoption', 'auth-googleclientid', 'facebook-app-id' );
		$this->facebookAppSecret			= apply_filters( 'futurewordpress/project/aicontentgenerator/system/getoption', 'auth-googleclientid', 'facebook-app-secret' );
		...
		add_filter( 'futurewordpress/project/aicontentgenerator/socialauth/redirect', [ $this, 'socialAuthRedirect' ], 10, 2 );
		add_filter( 'futurewordpress/project/aicontentgenerator/socialauth/link', [ $this, 'socialAuthLink' ], 0, 2 );
		...
		if( ! apply_filters( 'futurewordpress/project/aicontentgenerator/system/isactive', 'auth-enable' ) ) {return;}
		/**
		 * Actions.
		 */
    ...
    $auth_provider = get_query_var( 'auth_provider' );
      ...
      return $template;
			...
			$file = FUTUREWORDPRESS_PROJECT_AICONTENTGENERATOR_DIR_PATH . '/templates/auth/index.php';
