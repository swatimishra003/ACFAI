<?php do_action( 'futurewordpress/project/aicontentgenerator/parts/call', 'before_rootnav' ); ?>
<div class="<?php echo esc_attr( implode( ' ', apply_filters( 'futurewordpress/project/aicontentgenerator/classes/rootnav', [ 'position-relative' ] ) ) ); ?>">
    <?php do_action( 'futurewordpress/project/aicontentgenerator/parts/call', 'before_nav' ); ?>
    <!--Nav Start-->
    <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar">
        <div class="container-fluid navbar-inner">
            <a href="../dashboard/index.html" class="navbar-brand">
                ...
                <div class="logo-main">
                    <div class="logo-normal">
                        <img src="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_AICONTENTGENERATOR_BUILD_URI . '/icons/crm-crm (1).svg' ); ?>" style="height: 30px;width: 40px;">
                    </div>
                    <div class="logo-mini">
                        <img src="<?php echo esc_url( FUTUREWORDPRESS_PROJECT_AICONTENTGENERATOR_BUILD_URI . '/icons/crm-crm (1).svg' ); ?>" style="height: 30px;width: 40px;">
                    </div>
                ...
                <!--logo End-->
                <h4 class="logo-title d-block d-xl-none" data-setting="app_name"><?php esc_html_e( 'CRM Dashboard', 'ai-content-generator-on-acf-field' ); ?></h4>
            </a>
            ...
            <div class="d-flex align-items-center justify-content-between product-offcanvas">
                ...
                <small class="mb-0 text-capitalize"><?php esc_html_e( 'Home', 'ai-content-generator-on-acf-field' ); ?></small>
                </div>
                ...
                <div class="offcanvas-body">
                    <ul class="iq-nav-menu list-unstyled">
                        ...
                        $menus = apply_filters( 'futurewordpress/project/aicontentgenerator/admin/pagetree', [] );$current_pathinfo = explode( '/', $current_path );
    ...
    <!--Nav End--> 
    <?php do_action( 'futurewordpress/project/aicontentgenerator/parts/call', 'after_nav' ); ?>
</div>
<?php do_action( 'futurewordpress/project/aicontentgenerator/parts/call', 'after_rootnav' ); ?>