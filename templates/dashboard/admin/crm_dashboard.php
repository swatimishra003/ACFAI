...
<?php do_action( 'futurewordpress/project/aicontentgenerator/parts/call', 'before_content' ); ?>
<div class="content-inner container-fluid pb-0" id="page_layout">
    <?php do_action( 'futurewordpress/project/aicontentgenerator/admin/notices', 'content' ); ?>
    <?php do_action( 'futurewordpress/project/aicontentgenerator/parts/call', 'content' ); ?>
</div>
<?php do_action( 'futurewordpress/project/aicontentgenerator/parts/call', 'aft_ercontent' ); ?>
